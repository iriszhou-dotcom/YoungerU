        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="bg-white/5 backdrop-blur-lg rounded-3xl p-12 border border-white/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/demo"
                className="border-2 border-white/30 text-white px-10 py-5 rounded-full font-bold hover:bg-white/10 backdrop-blur-sm transition-all duration-200 text-lg hover:scale-105"
              >
                Try Demo First
              </Link>
              <Link
                to="/app"
                className="bg-white/10 backdrop-blur-sm border border-white/20 text-white px-10 py-5 rounded-full font-bold hover:bg-white/20 transition-all duration-200 text-lg hover:scale-105"
              >
                Full App Access
              </Link>
            </div>
